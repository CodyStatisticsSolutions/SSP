...
moderation.ancova1 <- function(iv, mv, dv, data){
	formula <- as.formula(paste(dv, "~", iv, "+ as.factor(",mv,") +",iv,"*as.factor(",mv,")"));
...
#moderation.ancova1("IVModerate", "Group.3", "Not.Normal.Dependent", data)
